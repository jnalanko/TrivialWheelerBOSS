...
int64_t search(WheelerBOSS* boss, const char* kmer, int64_t k){
    ...
    for(int64_t i = 0; i < k; i++){
        ...
        int64_t end = Select(boss->O, '1', right+2) - right - 2;
...
int main(int argc, char** argv){
    ...
    char* I = "110101010010101010101010101"; // Appended a '1' at the end to eliminate a special case in search
    char* O = "101001011101010101010010101"; // Appended a '1' at the end to eliminate a special case in search
